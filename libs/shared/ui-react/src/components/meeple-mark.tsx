...
export interface MeepleMarkProps {
  className?: string;
  size?: number;
}

/** Canonical Juegospedia meeple silhouette from the brand system. */
export function MeepleMark({ className, size }: MeepleMarkProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
